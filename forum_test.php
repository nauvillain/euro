...
echo "<div id='forum_pic'><img src='forum.gif'></div>\n";
echo "<div id='forum'>";
...
if($method=='thread'){
	...
	if($show=='yes'){
		...
		$sql=mysql_query($quer) or die(mysql_error());
		...
		for($i=0;$i<$tot;$i++){
			...
			$escuel=mysql_query($coueri) or die(mysql_error());
...
for($i=0;$i<$num_messages;$i++){
   ...
   echo "</div>\n";
   echo" </td></tr>";
   echo "	<tr><td><div id='message'>".$text."</div></td></tr>\n";
   echo "</table></tr></td>";
   echo "</table>";
   echo "</table></td></tr>";
