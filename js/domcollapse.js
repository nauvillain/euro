...
dc={
	triggerElements:'div', 	// elements to trigger the effect
	...
	closedPic:'img/plus.gif',
	closedAlt:'expand section',
	openPic:'img/minus.gif',
	...
	*/
	...
	init:function(e){
		...
		dc.tempLink.className='no_dec';
		dc.tempImg=document.createElement('img');
		dc.tempImg.className='no_dec';
		dc.tempLink.appendChild(dc.tempImg);
